...
user_routes.get('/resend_otp',userController.REsendOtp)
...
user_routes.get('/ordersuccess', orderController.orderSuccess)

//-----------------------------order page-----------------------------------------------------------

user_routes.get('/view_order_page', orderController.load_order_view_page)
user_routes.post('/createOrder', orderController.createOrder)
user_routes.get('/cancel_user',orderController.cancel_item)

//-----------------------------search items----------------------------------------------------------

user_routes.post('/search_items',userController.search_items)
